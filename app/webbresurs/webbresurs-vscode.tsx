// app/webbresurs/webbresurs-vscode.tsx
"use client";
...
export default function WebbresursVscode() {
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-12">
        <header className="mb-10 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-center">
            VS Code – smart sök & navigation
          </h1>

          <p className="text-center text-gray-300">
            Lathund för att hitta vilken fil/sida en mening eller kodsnutt finns
            i, hoppa till definitioner och se var kod används.
          </p>
        ...
        <footer className="mt-12 rounded-xl border border-gray-600 bg-gray-700 p-6">
          <h3 className="text-lg font-semibold mb-2">Snabbkombo</h3>
